...
1. Install visual studio 2019, git and cmake
   ...
   2. For cmake:
      ...
      3. ![ select "add CMake to environmental PATH"](https://github.com/sjulier/Refactored_ORB_SLAM2/raw/main/Doc/cmake.png " add CMake to environmental PATH")
...
1. Configure environmental variables:
   1. msbuild
      ...
      2. !["add msbuild path to PATH"](https://github.com/sjulier/Refactored_ORB_SLAM2/raw/main/Doc/PATH_vs.png " add msbuild to environmental PATH")
   2. VCPKG_ROOT
      1. It should be where you placed your vcpkg package, for my case it's  C:\src\
      2. !["add VCPKG_ROOT path to environmental variable"](https://github.com/sjulier/Refactored_ORB_SLAM2/raw/main/Doc/VCPKG_ROOT.png " add VCPKG_ROOT to environmental variable")
   3. VCPKG_DEFAULT_TRIPLET
      ...
      3. !["add VCPKG_DEFAULT_TRIPLET path to environmental variable"](https://github.com/sjulier/Refactored_ORB_SLAM2/raw/main/Doc/VCPKG_DEFAULT_TRIPLET.png " add VCPKG_DEFAULT_TRIPLET to environmental variable")
